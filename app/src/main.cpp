...
std::shared_ptr<UiConfiguration> SetupTestUiConfig(std::shared_ptr<UiConfigurationManager> ui_configuration_manager) {
    ...
    screen_configuration.widget_configurations.push_back(widget1);

    // Widget 2: IndicatorHorizontalChart (Bar)
    WidgetConfiguration widget2;
    ...
    screen_configuration.widget_configurations.push_back(widget2);

    // Widget 3: IndicatorHorizontalChart (Line)
    WidgetConfiguration widget3;
    ...
    screen_configuration.widget_configurations.push_back(widget3);

    // WidgetConfiguration widget4;
    ...
    // screen_configuration.widget_configurations.push_back(widget4);

    // Widget: IndicatorArcFill
    WidgetConfiguration widget5;
    ...
    screen_configuration.widget_configurations.push_back(widget5);

    // WidgetConfiguration widget6;
    ...
    // screen_configuration.widget_configurations.push_back(widget6);

    // Widget: BasicArcIcon
    WidgetConfiguration widget7;
    ...
    screen_configuration.widget_configurations.push_back(widget7);

    // WidgetConfiguration widget8;
    ...
    // screen_configuration.widget_configurations.push_back(widget8);
